...
const char* location = "koelcel-voor";    // De kamer of lokatie waar de sensor is geplaatst
float tempCorr = 0.5;              // Correctie waarde voor de gemeten temperatuur kamer1
